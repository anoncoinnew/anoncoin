import { Shield, Users, Zap, Menu as MenuIcon } from "lucide-react";
      ...
      <div className="px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <div className="w-10 h-10 bg-anon-purple rounded-lg flex items-center justify-center">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="text-right">
              ...
              <div className="text-anon-amber font-mono font-semibold">
                Высокая (авто)
              </div>
            </div>

            {/* Статус сети */}
            <div className="flex items-center space-x-2 glass-effect rounded-lg px-2 py-1">
              <div className="w-2 h-2 bg-anon-green rounded-full pulse-animation" />
